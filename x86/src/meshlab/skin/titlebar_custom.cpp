	...
	: QWidget(parent)
{
	...
	m_pMinimizeButton->setToolTip(QString::fromUtf8("最小化"));
	m_pMaximizeButton->setToolTip(QString::fromUtf8("最大化"));
	m_pCloseButton->setToolTip(QString::fromUtf8("关闭"));
	m_pMenuButton->setToolTip(QString::fromUtf8("皮肤"));
...
void TitleBar::updateMaximize()
{
	...
	if (pWindow->isTopLevel())
	{
		...
		if (bMaximize)
		{
			...
			m_pMaximizeButton->setIcon(pix);
			m_pMaximizeButton->setToolTip(QString::fromUtf8("还原"));
