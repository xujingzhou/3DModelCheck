...
void ChangeTextureNameDialog::InitDialog()
{
    ...
    ui->newtexturename->setWindowTitle(QTextCodec::codecForName("GBK")->toUnicode("重命名纹理") /*"Rename Texture"*/);
}
...
{
    this->texture = QFileDialog::getOpenFileName(new QWidget(), QTextCodec::codecForName("GBK")->toUnicode("打开图像文件") /*tr("Open Image File")*/, ".").toStdString();
