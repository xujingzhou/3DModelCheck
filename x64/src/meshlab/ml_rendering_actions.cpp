    ...
    :MLRenderingAction(parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("边界框") /*"Bounding Box"*/);
}
    ...
    :MLRenderingAction(parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("点集") /*"Points"*/);
}
    ...
    :MLRenderingAction(parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("线框") /*"Wireframe"*/);
}
    ...
    :MLRenderingAction(parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("曲面") /*"Fill"*/);
}
...
MLRenderingFauxEdgeWireAction::MLRenderingFauxEdgeWireAction( QObject* parent )
    :MLRenderingAction(parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("边缘线框") /*QString("Edges Wireframe")*/);
}
...
MLRenderingPerFaceNormalAction::MLRenderingPerFaceNormalAction( QObject* parent)
    :MLRenderingAction(parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("面") /*QString("Face")*/);
...
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("曲面") /*QString("Vert")*/);
	setIcon(QIcon(":/images/smooth.png"));
}
...
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("打开") /*QString("Enabled")*/);
}
...
MLRenderingPerWedgeTextCoordAction::MLRenderingPerWedgeTextCoordAction(QObject* parent)
    :MLRenderingAction(parent)
{
	setText(QTextCodec::codecForName("GBK")->toUnicode("楔入文本") /*QString("Wedge Text")*/);
...
MLRenderingDoubleLightingAction::MLRenderingDoubleLightingAction( QObject* parent)
    :MLRenderingAction(parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("双灯") /*QString("Double")*/);
}
...
MLRenderingSingleLightingAction::MLRenderingSingleLightingAction(QObject* parent)
	:MLRenderingAction(parent)
{
	setText(QTextCodec::codecForName("GBK")->toUnicode("单灯") /*QString("Single")*/);
}
...
MLRenderingFancyLightingAction::MLRenderingFancyLightingAction( QObject* parent)
    :MLRenderingAction(parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("模糊光照") /*QString("Fancy")*/);
}
    ...
    :MLRenderingAction(parent),_pm(pm)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("无") /*QString("None")*/); 
    setToolTip(QTextCodec::codecForName("GBK")->toUnicode("开灯/关灯") /*QString("Light on/off")*/);
}
...
MLRenderingFaceCullAction::MLRenderingFaceCullAction( QObject* parent)
    :MLRenderingAction(parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("剔除") /*QString("Cull")*/);
}
...
MLRenderingPerMeshColorAction::MLRenderingPerMeshColorAction(MLRenderingData::PRIMITIVE_MODALITY pm,QObject* parent)
    :MLRenderingAction(-1,parent),_pm(pm)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("网格") /*QString("Mesh")*/);  
}
...
MLRenderingPerVertexColorAction::MLRenderingPerVertexColorAction(MLRenderingData::PRIMITIVE_MODALITY pm,QObject* parent)
    :MLRenderingAction(-1,parent),_pm(pm)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("顶点") /*QString("Vert")*/);
...
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("自定义") /*QString("User-Def")*/);
}
    ...
    :MLRenderingAction(-1,parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("选择") /*QString("Selection")*/);
}
...
MLRenderingPointsDotAction::MLRenderingPointsDotAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("点") /*"Dot"*/);
}
...
MLRenderingVertSelectionAction::MLRenderingVertSelectionAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("顶点选择") /*"Vert Selection"*/);
...
MLRenderingFaceSelectionAction::MLRenderingFaceSelectionAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("面选择") /*"Face Selection"*/);
}
...
MLRenderingBBoxPerMeshColorAction::MLRenderingBBoxPerMeshColorAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("网格") /*"Mesh"*/);
}
...
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("自定义") /*"User-Def"*/);
}
    ...
    :MLRenderingAction(-1,parent)
{
    ...
    setText(QTextCodec::codecForName("GBK")->toUnicode("边缘装饰") /*"Edge Decorators"*/);
}
...
MLRenderingEdgeBoundaryAction::MLRenderingEdgeBoundaryAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
     setText(QTextCodec::codecForName("GBK")->toUnicode("边缘边界") /*"Edges Boundary"*/);
}
...
MLRenderingFaceBoundaryAction::MLRenderingFaceBoundaryAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("面边界") /*"Faces Boundary"*/);
}
...
MLRenderingEdgeManifoldAction::MLRenderingEdgeManifoldAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("非2维流型边缘装饰") /*"No 2-Manifold Edges Decorator"*/);
}
...
MLRenderingVertManifoldAction::MLRenderingVertManifoldAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("非2维流型顶点装饰") /*"No 2-Manifold Vertices Decorator"*/);
}
...
MLRenderingTexBorderAction::MLRenderingTexBorderAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("纹理边界装饰") /*"Texture Borders Decorator"*/);
}
...
MLRenderingDotAction::MLRenderingDotAction( QObject* parent )
    :MLRenderingAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("点装饰") /*"Dot Decorator"*/);
}
...
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("点大小") /*"Point Size"*/);
}
...
MLRenderingWireWidthAction::MLRenderingWireWidthAction( QObject* parent )
    :MLRenderingFloatAction(-1,parent)
{
    setText(QTextCodec::codecForName("GBK")->toUnicode("边缘宽度") /*"Edge Width"*/);
}
