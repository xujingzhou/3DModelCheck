...
{
	// Change color. Modified by Johnny Xu, 2017/2/21
	defaultGlobalParamSet->addParam(new RichColor(backgroundBotColorParam(), QColor(23, 58, 60), "MeshLab Bottom BackGround Color","MeshLab GLarea's BackGround Color(bottom corner)"));
    defaultGlobalParamSet->addParam(new RichColor(backgroundTopColorParam(), QColor(216, 237, 251), "MeshLab Top BackGround Color","MeshLab GLarea's BackGround Color(top corner)"));
    defaultGlobalParamSet->addParam(new RichColor(logAreaColorParam(), QColor(150, 130, 205), "MeshLab GLarea's Log Area Color","MeshLab GLarea's BackGround Color(bottom corner)"));
