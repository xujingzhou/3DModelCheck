...
{
	return QTextCodec::codecForName("GBK")->toUnicode("操作网格的工具") /*tr("Provide tools for moving meshes around the space")*/;
}
...
void EditManipulatorsPlugin::Decorate(MeshModel &model, GLArea *gla, QPainter* /*painter*/)
{
  ...
  if(current_manip == EditManipulatorsPlugin::ManNone)
  {
    StatusString1 += QTextCodec::codecForName("GBK")->toUnicode(" 无操作 ") /*"  NONE "*/;
  }
  else
  {
    switch(current_manip) 
    {
      case EditManipulatorsPlugin::ManMove:
        StatusString1 += QTextCodec::codecForName("GBK")->toUnicode(" 移动") /*"  Translate"*/;
        break;
      case EditManipulatorsPlugin::ManRotate:
        if(aroundOrigin) 
			StatusString1 += QTextCodec::codecForName("GBK")->toUnicode("沿网格原点旋转") /*"Rotate around Mesh Origin"*/;
                    
		else 
			StatusString1 += QTextCodec::codecForName("GBK")->toUnicode("沿边框中心点旋转") /*"Rotate around BBox center"*/;
        break;
      case EditManipulatorsPlugin::ManScale:
        if(aroundOrigin) 
			StatusString1 += QTextCodec::codecForName("GBK")->toUnicode("沿网格原点缩放") /*"Scale around Mesh Origin"*/;      
		else 
			StatusString1 += QTextCodec::codecForName("GBK")->toUnicode("沿边框中心点缩放") /*"Scale around BBox center"*/;
        break;
      default: ;
    }
    ...
    {
      case EditManipulatorsPlugin::ModX: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("X轴全局坐标: ") /*"X global"*/; 
		  break;
      case EditManipulatorsPlugin::ModY: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("Y轴全局坐标: ") /*"Y global"*/; 
		  break;
      case EditManipulatorsPlugin::ModZ: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("Z轴全局坐标: ") /*"Z global"*/; 
		  break;
      case EditManipulatorsPlugin::ModXX: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("X轴本地坐标: ") /*"X local"*/; 
		  break;
      case EditManipulatorsPlugin::ModYY: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("Y轴本地坐标: ") /*"Y local"*/; 
		  break;
      case EditManipulatorsPlugin::ModZZ: 
		  StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("Z轴本地坐标: ") /*"Z local"*/; 
		  break;
      default: 
        if((current_manip == EditManipulatorsPlugin::ManMove) || (current_manip == EditManipulatorsPlugin::ManRotate))
          StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("视图坐标: ") /*"viewport"*/;
        else if(current_manip == EditManipulatorsPlugin::ManScale)
          StatusString2 += QTextCodec::codecForName("GBK")->toUnicode("统一坐标: ") /*"uniform"*/;
        break;
    }
    ...
    if(isSnapping)
    {
      StatusString2 += QTextCodec::codecForName("GBK")->toUnicode(" 捕捉: ") + QString("%1").arg(snapto); 
    }
  }

  if(current_manip == EditManipulatorsPlugin::ManNone)
  {
    HelpString1 = QTextCodec::codecForName("GBK")->toUnicode("<br>按T键移动，R键旋转，S键缩放") /*"<br><i> press T to translate, R to rotate, S to scale</i>"*/;
  }
  else
  {
	 switch(current_manip)
    {
		case EditManipulatorsPlugin::ManMove   : 
			HelpString1 = QTextCodec::codecForName("GBK")->toUnicode("<br> 鼠标左键拖曳可移动") /*"<br> LEFT CLICK and DRAG to move"*/;
			break;
		case EditManipulatorsPlugin::ManRotate : 
			HelpString1 = QTextCodec::codecForName("GBK")->toUnicode("<br> 鼠标左键拖曳可旋转") /*"<br> LEFT CLICK and DRAG to rotate"*/; 
			break;
		case EditManipulatorsPlugin::ManScale  : 
			HelpString1 = QTextCodec::codecForName("GBK")->toUnicode("<br> 鼠标左键拖曳可缩放") /*"<br> LEFT CLICK and DRAG to scale"*/;
			break;
    }

    if((current_manip != EditManipulatorsPlugin::ManMove) || (current_manip_mode != EditManipulatorsPlugin::ModNone))
      HelpString1 += QTextCodec::codecForName("GBK")->toUnicode(" 按住Shift键捕捉") /*"  -  hold SHIFT to snap"*/;

    HelpString2="<br>";
	switch(current_manip_mode) 
    {
      case EditManipulatorsPlugin::ModX:  
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按X键切换到X轴本地坐标") /*"<br> press X to switch to X local"*/; 
		  break;
      case EditManipulatorsPlugin::ModY:  
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按Y键切换到Y轴本地坐标") /*"<br> press Y to switch to Y local"*/; 
		  break;
      case EditManipulatorsPlugin::ModZ:  
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按Z键切换到Z轴本地坐标") /*"<br> press Z to switch to Z local"*/; 
		  break;
      case EditManipulatorsPlugin::ModXX: 
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按X键切换到X轴全局坐标") /*"<br> press X to switch to X global"*/; 
		  break;
      case EditManipulatorsPlugin::ModYY: 
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按Y键切换到Y轴全局坐标") /*"<br> press Y to switch to Y global"*/; 
		  break;
      case EditManipulatorsPlugin::ModZZ: 
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按Z键切换到Z轴全局坐标") /*"<br> press Z to switch to Z global"*/; 
		  break;
      default:   
		  HelpString2 = QTextCodec::codecForName("GBK")->toUnicode("<br> 按X,Y,Z键可选择一个轴") /*"<br> press X Y Z to select an axis"*/;    
		  break;
    }
    ...
    {
		if(aroundOrigin)  
		  HelpString2 += QTextCodec::codecForName("GBK")->toUnicode(" 按空格键以边框中心点为中心") /*"  -  press SPACE to pivot on BBox center"*/;
		else  
		  HelpString2 += QTextCodec::codecForName("GBK")->toUnicode(" 按空格键以网格原点为中心") /*"  -  press SPACE to pivot on Mesh Origin"*/;
    }

    HelpString3 = QTextCodec::codecForName("GBK")->toUnicode("<br>按回车键可应用操作，回退键可取消操作") /*"<br>press RETURN to apply, BACKSPACE to cancel"*/;
  }

  // Modified by Johnny Xu, 2017/2/20
  this->RealTimeLogChinese(QTextCodec::codecForName("GBK")->toUnicode("操作工具"), "", QString("<b>"+StatusString1+"</b>"+StatusString2+HelpString1+HelpString2+HelpString3));
