 ...
 QString SelectionFilterPlugin::filterName(FilterIDType filter) const
{
	switch(filter)
	{
		...
		case FP_SELECT_NONE :		       
			return QTextCodec::codecForName("GBK")->toUnicode("取消选择") /*QString("Select None")*/;
		case FP_SELECT_INVERT :		      
			return QString("Invert Selection");
		case FP_SELECT_DELETE_VERT :	
			return  QTextCodec::codecForName("GBK")->toUnicode("删除选中点集") /*QString("Delete Selected Vertices")*/;
		case FP_SELECT_DELETE_FACE :    
			return QString("Delete Selected Faces");
		case FP_SELECT_DELETE_FACEVERT :   
			return QTextCodec::codecForName("GBK")->toUnicode("删除选中面") /*QString("Delete Selected Faces and Vertices")*/;
...
void SelectionFilterPlugin::initParameterSet(QAction *action, MeshModel &m, RichParameterSet &parlst)
{
	switch(ID(action))
	{
		...
		//case FP_SELECT_NONE:
		//{
		//	parlst.addParam(new RichBool("allFaces", true, QTextCodec::codecForName("GBK")->toUnicode("选择所有面"), "" /*"De-select all Faces", "If true the filter will de-select all the faces."*/));
		//	parlst.addParam(new RichBool("allVerts", true, QTextCodec::codecForName("GBK")->toUnicode("选择所有点"), "" /*"De-select all Vertices", "If true the filter will de-select all the vertices."*/));
		//}break;
